...
// Query 5: Adherent profiles with statistics
const query5 = `
SELECT 
    a.id_adh,
    a.nom,
...
// Query 6: Genre trends by decade
const query6 = `
WITH genre_stats AS (
    SELECT 
        l.genre,
...
// Query 7: Author statistics by loan ratio
const query7 = `
...
// Query 8: Loan duration by genre
const query8 = `
SELECT 
    l.genre,
    COUNT(e.id_emprunt) AS nombre_emprunts,
...
// Query 10: Personalized book recommendations
const query10 = `
...
// Query 11: Monthly loan trends by genre
const query11 = `
WITH mois_annee AS (
